        ...
        <form method="post" novalidate>
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="nom" class="form-label">Nom:</label><span class="text-danger ms-1"><?= $errors["lastname"] ?? "" ?></span>
                    <input type="text" class="form-control" id="nom" placeholder="Entrez votre nom" require name="lastname" value="<?= $_POST['lastname'] ?? "" ?>">
                </div>
                <div class="col-sm p-0">
                    <label for="prenom" class="form-label">Prénom</label><span class="text-danger ms-1"><?= $errors["firstname"] ?? "" ?></span>
                    ...
                    <div class="col-sm p-0">
                    <label for="Pseudo" class="form-label">Pseudo</label><span class="text-danger ms-1"><?= $errors["pseudo"] ?? "" ?></span>
            ...
            <div>
                <label for="email" class="form-label">Email</label><span class="text-danger ms-1"><?= $errors["email"] ?? "" ?></span>
                <input type="email" class="form-control" id="email" placeholder="Entrez votre email" require name="email" value="<?= $_POST['email'] ?? "" ?>">
            </div>
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="mdp" class="form-label">Mot de passe</label><span class="text-danger ms-1"><?= $errors["password"] ?? "" ?></span>
                ...
                <div class="col-sm p-0">
                <label for="mdp2" class="form-label">Mot de passe</label><span class="text-danger ms-1"><?= $errors["passwordconfirm"] ?? "" ?></span>
            ...
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="date_naissance" class="form-label">Date de naissance</label><span class="text-danger ms-1"><?= $errors["lastname"] ?? "" ?></span>
                    <input type="date" class="form-control" id="date_naissance" require name= "date de naissance">
                </div>
                <div class="col-sm p-0">
                    <label class="form-label">Genre</label><span class="text-danger ms-1"><?= $errors["genre"] ?? "" ?></span>
